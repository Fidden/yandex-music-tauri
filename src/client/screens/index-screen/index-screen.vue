<template>
	<main :class="cnIndexScreen()">
		<IndexScreenUserPlaylists/>
		<IndexScreenPersonal/>
...
import IndexScreenPlayContext from './index-screen__play-context.vue';
import IndexScreenUserPlaylists from './index-screen__user-playlists.vue';
</script>
